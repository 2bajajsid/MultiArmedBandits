...
drop_out_point_two_five = DropOut_FI(stochastically_constrained_fast_switch_data_job, dropout_prob=0.25)
drop_out_point_five = DropOut_FI(stochastically_constrained_fast_switch_data_job, dropout_prob=0.5)
...
partial_info_ground = Partial_Info_Play_Ground(stochastically_constrained_data_job, 
                                               [drop_out_point_zero_one, drop_out_point_zero_five,  
                                                drop_out_point_one, drop_out_point_two_five], 
...
drop_out_point_one = DropOut_PI(low_gap_stochastic_data_job, dropout_prob=0.1)
drop_out_point_two_five = DropOut_PI(low_gap_stochastic_data_job, dropout_prob=0.25)
