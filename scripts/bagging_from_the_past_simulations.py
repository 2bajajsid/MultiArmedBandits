...
from bandit_algorithms.bagging_from_the_past import BaggingFromThePast_PI, BaggingFromThePast_FI
import numpy as np
import math
...
bp_1 = BaggingFromThePast_PI(high_gap_stochastic_data_job, get_bag_size = bag_size_log_t, bag_label = "log(t)", add_bag = False)
bp_2 = BaggingFromThePast_PI(high_gap_stochastic_data_job, get_bag_size = bag_size_log_t, bag_label = "log(t)", add_bag = True)
bp_3 = BaggingFromThePast_PI(high_gap_stochastic_data_job, get_bag_size = bag_size_sqrt_t, bag_label = "sqrt(t)", add_bag = False)
bp_4 = BaggingFromThePast_PI(high_gap_stochastic_data_job, get_bag_size = bag_size_sqrt_t, bag_label = "sqrt(t)", add_bag = True)
...
bp_1 = BaggingFromThePast_FI(high_gap_stochastic_data_job, get_bag_size = bag_size_log_t, bag_label = "log(t)", add_bag = False)
bp_2 = BaggingFromThePast_FI(high_gap_stochastic_data_job, get_bag_size = bag_size_log_t, bag_label = "log(t)", add_bag = True)
bp_3 = BaggingFromThePast_FI(high_gap_stochastic_data_job, get_bag_size = bag_size_sqrt_t, bag_label = "sqrt(t)", add_bag = False)
bp_4 = BaggingFromThePast_FI(high_gap_stochastic_data_job, get_bag_size = bag_size_sqrt_t, bag_label = "sqrt(t)", add_bag = True)
