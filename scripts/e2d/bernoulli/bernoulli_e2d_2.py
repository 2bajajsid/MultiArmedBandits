...
meta_algo = Meta_Algo(M = M, K = K, T = T, num_runs = NUM_RUNS,
                      ...
                      file_name = "bernoulli/Gaussian_{0}_Gap_{1}_MC.".format(GAP_STRING, MC_STRING),
...
plt.title('Empirical bias of Squared-Hellinger estimate for Bernoulli model classes vs. Monte carlo sample size m', fontsize=14, pad=20)
plt.legend()
plt.xlabel("Empirical bias of Squared-Hellinger estimate")
plt.savefig("/Users/sidbajaj/MultiArmedBandits/results/e2d/bernoulli/bernoulli_bias")
plt.close()