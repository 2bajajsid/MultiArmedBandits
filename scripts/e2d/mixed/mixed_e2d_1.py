...
from e2d.model_collection.mixed_model_collection import Mixed_Model_Collection
...
NUM_RUNS = 200
m = 25 # Monte-Carlo Sample Size

model_class = Mixed_Model_Collection(K = K, M = M, Optimality_Gap=5.0)
...
gamma = [0.01, 1.0, 10, 100, 500, 1000, 2500, 5000]
...
meta_algo = Meta_Algo(M = M, K = K, T = T, 
                      ...
                      file_name = "mixed/Mixed_High_Gap_Low_MC",
                      title = "Averaged Regret Over Time [Mixed Model Class (High Gap, Low MC)]")
