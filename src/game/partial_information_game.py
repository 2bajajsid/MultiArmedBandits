...
class Partial_Information_Game(Game):
    ...
    def simulate_one_run(self):
        ...
        for t in range(self.data_generating_mechanism.get_T()):
            ...
            if (self.data_generating_mechanism.mustUpdateStatistics):
                self.data_generating_mechanism.update_statistics(I_t, r_t[I_t])
        ...
        print(self.data_generating_mechanism.posterior_mean)
